...
//   // Fetch tour types and locations from the same endpoint
//   useEffect(() => {
//     const fetchData = async () => {
//       try {
//         const res = await fetch(
//           "http://127.0.0.1:8000/api/tour-types-and-locations/"
//         ); // Updated endpoint
//         if (res.ok) {
//           const { tourTypes: fetchedTourTypes, locations: fetchedLocations } =
//             await res.json();
//           setTourTypes(fetchedTourTypes);
//           setLocations(fetchedLocations);
//         } else {
//           console.error("Failed to fetch tour types and locations.");
//         }
//       } catch (error) {
...
//   if (fetching) {
//     return <div>Loading tour types and locations...</div>;
//   }
