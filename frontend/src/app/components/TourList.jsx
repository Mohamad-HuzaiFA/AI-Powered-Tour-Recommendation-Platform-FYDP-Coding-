                ...
                <div className="p-6 flex flex-col justify-between h-full">
                  ...
                  <div className="flex gap-4 mt-2">
                    ...
                    <button
                      ...
                      className="cursor-pointer flex-1  bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-md shadow-md transition duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 text-sm md:text-base"
                    >
                      Book Now
                    </button>
                  </div>
