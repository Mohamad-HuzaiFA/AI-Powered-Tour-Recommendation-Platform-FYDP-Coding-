...
// //     data.tags.forEach((tag) => formData.append("tags", tag)); // Tags are now directly in data
...
//       data.tags.forEach((tagId) => formData.append("tags", tagId)); // Sending UUIDs
//     }
//     const keywordsArray = data.ai_keywords
//       .split(",")
//       .map((s) => s.trim())
